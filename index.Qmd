...
::: {style="font-size: 70%;"}
- Suggest components, stressors, and pathways
...
::: {style="font-size: 70%;"}
- Find and structure relevant evidence
...
::: {style="font-size: 70%;"}
- Query results and draft summaries
...
::: {style="font-size: 70%;"}
- Human reviewed, sourced, decision support
...
### Data Management
::: {style="font-size: 90%;"}
- Structure evidence for reuse
- Build living regional context
:::
:::
...
### Decision-support tools
::: {style="font-size: 90%;"}
- Explore risks and pathways of effect
- Project assessment and generate reports
:::
:::
...
### Automated workflows
::: {style="font-size: 90%;"}
- Update data and rerun analyses
